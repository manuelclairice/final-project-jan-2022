...
type LikedActivity = { id: string; stars: number };
type LikeActivities = LikedActivity[];

export function setParsedCookie(key: string, value: LikeActivities) {
...
export function stringifyCookieValue(value: LikeActivities) {
